...
public extension RMCharacter {
    public static let sample: RMCharacter = RMCharacter(
           id: 1,
           name: "Rick Sanchez",
           status: .alive,
           species: "Human",
           type: "",
           gender: "Male",
           origin: RMOrigin(name: "Earth (C-137)", url: "https://rickandmortyapi.com/api/location/1"),
           location: RMLocation(name: "Citadel of Ricks", url: "https://rickandmortyapi.com/api/location/3"),
